...
namespace drive_api.Services.Email
{
    public class EmailHandler
    {
        ...
        public EmailHandler(ILogger<EmailHandler> logger, AppConfigInfo appConfigInfo, IWebHostEnvironment env)
        {
            _env = env;
            _logger = logger;
        ...
        public async Task Init()
        {
            ...
            {
                _logger.LogError(e, "邮件服务初始化失败（模板加载错误）");
                // 这里如果不抛出异常，后续发邮件会因为模板为空报错，看你业务需求
                // throw; 
            }
        }
