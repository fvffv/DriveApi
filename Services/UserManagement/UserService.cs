...
{
    public class UserService(Helper helper, IWebHostEnvironment env, IContentInspector contentInspector, ILogger<UserService> logger, ICache icache, ISqlSugarClient sqlSugarClient, AppConfigInfo appConfigInfo, EmailService emailHandler, JwtEventHandler jwtEventHandler)
    {
        ...
        private readonly EmailService _emailHandler = emailHandler;
        ...
        public async Task<DefaultMsg> RegisterUserAsync(UserRegInfo userRegInfo)
        {
            ...
            User u = new User()
            {
                ...
                Status = _appConfigInfo.dbSetting.CreateAdminUser ? 2 : 0,
                TotalStorageGB = 0,
                RootFolderId = fid,
        ...
        new CustomView { Name = "所有文档", Type = 0, Icon = "fa-file-lines", Keywords = new string[] { ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".pdf", ".txt", ".md" } },
        new CustomView { Name = "所有图片", Type = 0, Icon = "fa-image", Keywords = new string[] { ".jpg", ".jpeg", ".png", ".gif", ".bmp", ".webp", ".svg", ".ico", ".tiff" } },
        new CustomView { Name = "所有视频", Type = 0, Icon = "fa-film", Keywords = new string[] { ".mp4", ".avi", ".mkv", ".mov", ".wmv" } },
        new CustomView { Name = "所有音频", Type = 0, Icon = "fa-music", Keywords = new string[] { ".mp3", ".wav", ".flac", ".aac" } },
        new CustomView { Name = "压缩文件", Type = 0, Icon = "fa-file-zipper", Keywords = new string[] { ".zip", ".rar", ".7z", ".tar", ".gz" } },
        new CustomView { Name = "前端代码", Type = 0, Icon = "fa-code", Keywords = new string[] { ".js", ".ts", ".vue", ".html", ".css", ".json" } },
        new CustomView { Name = "后端代码", Type = 0, Icon = "fa-database", Keywords = new string[] { ".cs", ".py", ".java", ".cpp", ".go", ".sql" } }
                   }
                }
            };

            if (_appConfigInfo.dbSetting.CreateAdminUser)
            {
                _appConfigInfo.dbSetting.CreateAdminUser = false;
                File.WriteAllText(Path.Combine(AppContext.BaseDirectory, "appsettings.json"), JsonSerializer.Serialize(_appConfigInfo, new JsonSerializerOptions { WriteIndented = true }));
            }
